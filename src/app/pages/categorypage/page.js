...
import Tvunit from "../../../../public/images/TVUnitimage.jpeg"
...
const Category = () => {
  return (
    <>
    <Navbar />
    <section style={{ backgroundColor: "#fff", marginTop:'100px' }}>
        ...
        <div className="round_container">
          <Link href="/pages/dressingtabledisplay">
              ...
              <Image
                ...
                alt="img"
              />
              <p className="txt_container">Dressing Table</p>
        ...
        <div className="round_container">
          <Link href="/pages/tvunit">
              ...
              <Image
                ...
                alt="img"
              />
              <p className="txt_container">TV Unit</p>
