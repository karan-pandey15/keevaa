              ...
              >
                ...
                {isPagesSubMenuOpen && (
                  ...
                  >
                    ...
                    <li className="py-2">
                          <Link href="/pages/beddisplay">BED</Link>
                        </li>

                        <li className="py-2">
                          <Link href="/pages/sofadisplay">SOFA</Link>
                        </li>

                        <li className="py-2">
                          <Link href="/pages/chairdisplay">CHAIR</Link>
                        </li>

                        <li className="py-2">
                          <Link href="/pages/tabledisplay">TABLE</Link>
                        </li>

                        
                        <li className="py-2">
                          <Link href="/pages/kafsardisplay">KAFSAR</Link>
                        </li>

                        <li className="py-2">
                          <Link href="/pages/wardrobedisplay">WARDROBE</Link>
                        </li>

                        <li className="py-2">
                          <Link href="/pages/kitchendisplay">KITCHEN</Link>
                        </li>

                        <li className="py-2">
                          <Link href="/pages/windowdisplay">WINDOW</Link>
                        </li>  
