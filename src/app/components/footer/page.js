        ...
        <footer className="footer_container">
          <div className="footer_heading_container">
            <div className="">
              ...
              Keeva.in is an online store where you can browse through images of various furnture designs. When you find something you like, you can place and order, and we wll custom make that piece of furniture for you.
              </p>
            </div>
          </div>
